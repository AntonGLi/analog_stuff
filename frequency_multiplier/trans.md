...
$R=\frac{1}{g_N}=\frac{1}{375\cdot1.5}=1.78 \space кОм$
...
$R=\frac{1}{g_N}=\frac{1}{375\cdot0.6}=4.44 \space кОм$
...
Пусть нужно коммутировать малый переменный сигнал, расположенный на уровне $U$ по постоянному току, при помощи ключа с теми же параметрами, что выше. Найти паразитные параметры ключа: сопротивление и ёмкость, оценить их влияние в случае, когда нагрузкой служит ёмкость затвора величиной $10 \space фФ$. Суммарная электростатическая ёмкость диэлектрика под затворами ключа $20 \spaceфФ$.
