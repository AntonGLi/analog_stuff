...
Рассмотрим вначале вспомогательную классическую задачу. Два конденсатора различной ёмкости C_1 и C_2, заряженные до напряжений U_1 и U_2 объединяются в параллель. Найти общее напряжение U_3, потерю энергии при взаимодействии Q.
...
Вернёмся charge pump и рассмотрим КПД передачи от одного конденсатора к другому. Основные параметры схемы - C_1 (буферный), C_2 (выходной). При подключении нагрузки (резистора) к C_2 конденсатор разряжается, что означает уменьшение U_2 для следующего цикла зарядки. При этом медленная разрядка практически не влияет на КПД быстрого процесса передачи энергии от C_1 к C_2 при замыкании правого ключа. 

В этом случае удобна следующая замена: $U_2=U_1-\Delta U$ (напряжение на правом конденсаторе на известную величину меньше). Полученные выше выражения приводятся к следующему виду:

$$Q=\frac{C_1C_2(\Delta U)^2}{2(C_1+C_2)}$$

$$U_3=U_1-\frac{C_2\Delta U}{C_1+C_2}$$
...
$$\eta=\frac{1-\frac{C_1\Delta U+C_2\Delta U+C_2\Delta U}{2U_1(C_1+C_2)}}{1-\frac{C_2\Delta U}{2U_1(C_1+C_2)}}$$

$$\eta=\frac{1-\frac{C_2\Delta U}{2U_1(C_1+C_2)}-\frac{C_1\Delta U+C_2\Delta U}{2U_1(C_1+C_2)}}{1-\frac{C_2\Delta U}{2U_1(C_1+C_2)}}$$

$$\eta=\frac{1-\frac{C_2}{C_1+C_2}\frac{\Delta U}{2U_1}-\frac{\Delta U}{2U_1}}{1-\frac{C_2}{C_1+C_2}\frac{\Delta U}{2U_1}}$$
