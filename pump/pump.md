...
Схему можно сделать симметричной, добавив второй PMOS между C3 и C2. Разница оказывается такой же, как между диодом и диодным мостом - C2 заряжается независимо от фазы CLK.
